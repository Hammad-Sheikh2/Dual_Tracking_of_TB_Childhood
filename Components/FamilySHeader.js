...
export default function FamilySHeader(props){
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.button} onPress={()=>{props.navigation.navigate("AddChild",{name:"",dob:new Date,gender:"MALE",userId:props.userId,navigation:props.navigation});}}>
